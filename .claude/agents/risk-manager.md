...
`knowledge/risk-manager/` (each `.md` is a topic you've studied) and run
...
text), write a distilled, sourced note to `knowledge/risk-manager/<slug>.md`
...
Agently if reachable) and `hf-bot study record --agent risk-manager --topic <topic>
