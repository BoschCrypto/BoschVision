...
`knowledge/setup-scanner/` (each `.md` is a topic you've studied) and run
...
text), write a distilled, sourced note to `knowledge/setup-scanner/<slug>.md`
...
Agently if reachable) and `hf-bot study record --agent setup-scanner --topic <topic>
